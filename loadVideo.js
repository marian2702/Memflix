function fetchMovieData(movieTitle) {
  fetch("./moviesDB.json")
      ...
      .then(data => {
          const movie = data.moviesDatabase.find(m => m.title == movieTitle);
          if (movie) {
                      ...
                      <div class="video-movie-body-section-text-sub-title-description">
                        ...
                        <div class="episode-season-info-container">
                          <div class="episode-season-info-realease-director">
                            ...
                            <p id="movie-cast"><i class="fas fa-users"></i> Cast: ${movie.cast.join(', ')}</p>
...
if (movieTitle) {
  fetchMovieData(movieTitle); // Fetch only the data for the clicked movie
} else {
